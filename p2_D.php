<?php
 ...
 $picasA = array("A1_" =>  36, "A2_" => 39, "A3_" => 42, "A4_" => 40, "A5_" => 40, "B1_" => 38, "B2_" => 32, "B3_" => 24);
 
 $aros = array("1" => 80, "2" => 40);
...
?>	
		ctx.beginPath();
		ctx.arc(<?=(800 + $i*50)?>,<?=(570-($j+$z)*5)?>,2,0,2*Math.PI);
		ctx.fillStyle = datos[<?=($y)?>];
		ctx.fill();
		ctx.closePath();
...
?>	
		ctx.beginPath();
		ctx.arc(<?=(800 + $i*50)?>,<?=(95-($j)*5)?>,2,0,2*Math.PI);
		ctx.fillStyle = datos[<?=($y)?>];
		ctx.fill();
		ctx.closePath();
