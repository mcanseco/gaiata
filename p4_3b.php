...
// echo $una . "</br>";
 ...
 //echo $tres . "</br>";
// $tres = $g->aros[0]->tira_sube("#00FF00", 1, true, 1, -1, -1, $g->mapeo);
// echo $tres . "</br>";

// $tres = $g->aros[0]->tira_sube("#00FF00", 1, true, 2, -1, -1, $g->mapeo);
// echo $tres . "</br>";

 $tres = $g->gaiato->tira_sube("#00FF00", 1, true, 1, -1, -1, $g->mapeo);
 echo $tres . "</br>";
 $tres = $g->gaiato->tira_sube("#00FF00", 1, true, 2, -1, -1, $g->mapeo);
 echo $tres . "</br>";
